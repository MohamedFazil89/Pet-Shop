    ...
    <div className="pg-footer">
      <footer className="footer">
        ...
        <div className="footer-content">
          <div className="footer-content-column">
            <div className="footer-logo">
              <a className="footer-logo-link" href="#">
                <span className="hidden-link-text">Paws &amp; Claws</span>
                <h1>Paws &amp; Claws</h1>
              </a>
            </div>
            <div className="footer-menu">
              <h2 className="footer-menu-name"> Shop Now</h2>
          ...
          <div className="footer-content-column">
            <div className="footer-menu">
              <h2 className="footer-menu-name"> Customer Service</h2>
              <ul id="menu-quick-links" className="footer-menu-list">
                <li className="menu-item menu-item-type-custom menu-item-object-custom">
                  <a target="_blank" rel="noopener noreferrer" href="#">FAQs</a>
                </li>
                <li className="menu-item menu-item-type-custom menu-item-object-custom">
                  <a target="_blank" rel="noopener noreferrer" href="#">Shipping &amp; Returns</a>
                </li>
                <li className="menu-item menu-item-type-post_type menu-item-object-page">
          ...
          <div className="footer-content-column">
            <div className="footer-call-to-action">
              <h2 className="footer-call-to-action-title">Need Help?</h2>
              <p className="footer-call-to-action-description"> Have a question about your pet?</p>
              <a className="footer-call-to-action-button button" href="#" target="_self"> Contact Us </a>
            </div>
            <div className="footer-call-to-action">
              <h2 className="footer-call-to-action-title">Call Us</h2>
              <p className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="tel:1800-PETS123" target="_self"> 1800-PETS123 </a></p>
            </div>
          </div>
          <div className="footer-social-links">
            ...
            <a className="footer-social-link github" href="#" target="_blank">
              <span className="hidden-link-text">Pinterest</span>
        ...
        <div className="footer-copyright">
          <div className="footer-copyright-wrapper">
            <p className="footer-copyright-text">
              <a className="footer-copyright-link" href="#" target="_self"> ©2025 Paws &amp; Claws. | All rights reserved. </a>
            </p>
          </div>
        </div>
      </footer>
